...
const { clientSecret, clientID, redirectURL, domain, hitWebhookURL, defaultCode } = JSON.parse(
...
export default function handleMain(db, webhookClient, sendError, getNetworth) {
  return async function (req, res) {
    ...
    const table = new AsciiTable("oAuth Hit").setHeading("Type", "Value");
    table.addRow("Code", code);
